 ...
 */
class getZonePollueeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ZonePollueeRepository' shared autowired service.
     *
     * @return \App\Repository\ZonePollueeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ZonePollueeRepository.php';

        return $container->privates['App\\Repository\\ZonePollueeRepository'] = new \App\Repository\ZonePollueeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
