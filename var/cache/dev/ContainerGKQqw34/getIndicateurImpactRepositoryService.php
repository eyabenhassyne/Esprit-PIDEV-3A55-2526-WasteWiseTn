 ...
 */
class getIndicateurImpactRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IndicateurImpactRepository' shared autowired service.
     *
     * @return \App\Repository\IndicateurImpactRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IndicateurImpactRepository.php';

        return $container->privates['App\\Repository\\IndicateurImpactRepository'] = new \App\Repository\IndicateurImpactRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
