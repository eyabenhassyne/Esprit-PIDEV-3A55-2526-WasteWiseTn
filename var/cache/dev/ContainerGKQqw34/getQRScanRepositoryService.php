 ...
 */
class getQRScanRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\QRScanRepository' shared autowired service.
     *
     * @return \App\Repository\QRScanRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QRScanRepository.php';

        return $container->privates['App\\Repository\\QRScanRepository'] = new \App\Repository\QRScanRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
